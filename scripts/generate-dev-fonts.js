...
async function compressFonts() {
	try {
		...
		// 开发环境：直接输出到 public/assets/font
		const distFontDir = path.join(__dirname, "../public/assets/font");
        console.log("ℹ Generating fonts for Development environment (into public/assets/font)...");
